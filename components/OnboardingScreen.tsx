  ...
  const handleCompleteOnboarding = async () => {
    ...
    try {
      ...
      const onboardingData = {
        height: parseFloat(userData.personalInfo.height) || undefined,
        weight: parseFloat(userData.personalInfo.weight) || undefined,
        age: parseInt(userData.personalInfo.age) || undefined,
        gender: userData.personalInfo.gender || undefined,
        cooking_level: userData.cookingLevel,
        family_size: userData.familySize,
        location: userData.location,
        activity_level: 'moderate', // Default value
        // Note: In a real app, you'd map these to actual IDs from the backend
